...
import PROGRAMAS_EM_JAVA.EstruturaDeDados.MenuDeListas.MenorCaminho.GrafoMenorCaminhoNaoDirecionadoPonderado;
import PROGRAMAS_EM_JAVA.EstruturaDeDados.MenuDeListas.MenorCaminho.GrafoMenorCaminhoDirecionadoPonderado;
import PROGRAMAS_EM_JAVA.EstruturaDeDados.MenuDeListas.MenorCaminho.MenorNaoCaminhoDirecionado;
...
public class MenuLista {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("[3].Menor caminho de grafos não direcionados");
            System.out.println("[4].Menor caminho de grafos não direcionados ponderados");
            System.out.println("[5].Menor caminho de grafos direcionados ");
            System.out.println("[6].Menor caminho de grafos direcionados ponderados ");
            ...
            switch (escolha1) {
                case 1:
                    ListAdjDirecionada listAdjNaoDirecionada = new ListAdjDirecionada(size);
                    listAdjNaoDirecionada.inserirValor(graph);
                    listAdjNaoDirecionada.exibirLista();
                    break;

                case 2:
                    ListAdjNaoDirecionada listAdjDirecionada = new ListAdjNaoDirecionada(size);
                    listAdjDirecionada.inserirValor(graph);
                    listAdjDirecionada.exibirLista();
                    break;

                case 3:
                    MenorNaoCaminhoDirecionado menorCaminhoNãoDirecionado = new MenorNaoCaminhoDirecionado(size);
                    menorCaminhoNãoDirecionado.adicionarAresta(graph);
                    menorCaminhoNãoDirecionado.bfs(menorCaminhoNãoDirecionado, 0);
                    break;

                case 4:
                    GrafoMenorCaminhoNaoDirecionadoPonderado grafoMenorCaminhoNaoDirecionadoPonderado = new GrafoMenorCaminhoNaoDirecionadoPonderado(size, graph);
                    grafoMenorCaminhoNaoDirecionadoPonderado.addElemento(graph);
                    int[] distancias = grafoMenorCaminhoNaoDirecionadoPonderado.dijkitra(0);
                ...
                case 6:
                    ...
                    int[] distances = grafoMenorCaminhoDirecionadoPonderado.dijkitra(0);
                    for (int i = 0; i < size; i++) {
    ...
    public static int[][] Graph() {
        ...
        System.out.println("[1].Não Direcionado");
        System.out.println("[2].Direcionado");
        System.out.println("[3].Não Direcionado Ponderado");
