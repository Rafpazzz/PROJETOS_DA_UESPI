...
public class VetorJava {
    private Object[] a; //generalizaçao de tipo de variavel.
    ...
    public void inserirElemento(Object data) {
        try{
            a[cont] = data;
            cont++;
...
//        s+=" ]";
    ...
    public boolean existeElemento(Object data) {
    ...
    public void adicionaDeterminadaPosicao(Object data, int posicao) throws Exception {
